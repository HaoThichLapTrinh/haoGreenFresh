  ...
  return (
    ...
    >
      <Link to={`/products/${id}`} className="relative overflow-hidden">
        ...
        <div
          className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all"
        />
      </Link>
      ...
      <div className="p-4 flex flex-col items-center text-center">
        ...
        <button
          onClick={handleAdd}
          className="
            bg-green-600 text-white py-2 px-4 rounded-lg w-full 
            hover:bg-green-700 active:scale-95 transition-transform duration-150
          "
        >
          🛒 Thêm giỏ hàng
        </button>
